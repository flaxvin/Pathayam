...
- R6.m A claim between budgets MAY be **forgiven**, in whole or in part, by whoever is owed. It is an expense filed to a category in the forgiver's budget and income in the other's (`15` §4A) — never a number deleted, and never a reason the household pays the bank less. Forgiving a debt the household owes a member is the existing cover-overspend flow and needs no separate action.
