...
- R6.m A balance between budgets MAY be closed by agreement — *call it even* — in whole or in part, by whoever is ahead. It is an expense filed to a category in their budget and income in the other's (`15` §4A.4), never a number deleted, and never a reason the household pays the bank less. Covering your *own* negative household envelope is not this: it raises your share for the month (`15` §4A.2) and is the existing cover-overspend flow.
