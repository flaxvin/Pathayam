...
- R6.n Copy about money between household members MUST NOT use the language of debt (`15` §4A.1). *Owes*, *debt*, *write off* and *forgive* are right for family lending, where the other party is outside the household, and wrong between partners. Say who is **ahead** or **behind**, and offer *put it down to me*, *I'll pick it up*, or *call it even*.
